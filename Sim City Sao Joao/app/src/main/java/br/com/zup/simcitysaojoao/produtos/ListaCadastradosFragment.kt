 ...
 * Use the [ListaCadastradosFragment.newInstance] factory method to
...
class ListaCadastradosFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ListaCadastradosFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ListaCadastradosFragment().apply {
