 ...
 * Use the [CadastrarProdutosFragment.newInstance] factory method to
...
class CadastrarProdutosFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CadastrarProdutosFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CadastrarProdutosFragment().apply {
